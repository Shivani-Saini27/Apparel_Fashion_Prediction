...
def home():
    #pic1= os.path.join(app.config['UPLOAD_FOLDER'],'logo.png','fahion_image.png','jumbo3.jpg')
        ...
        try:
            if file and allowed_file(file.filename):
                ...
                with graph.as_default():
                    model1 = tf.keras.models.load_model('clothing_classification_modelupdated.h5')
